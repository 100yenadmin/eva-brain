...
| **media-ingest** | Video, audio, PDF, books, screenshots, GitHub repos. Transcripts, entity extraction, backlink propagation. See also [`docs/guides/media-evidence.md`](docs/guides/media-evidence.md) for the runtime architecture vocabulary behind media artifacts, segments, evidence, and resolvers. |
